...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  void _isUserLoggedIn(
    ...
    emit(AuthLoading());
    final res = await _currentUserCase(NoParams());

    res.fold(
      (l) => emit(AuthFailure(l.message)),
      (r) => {print("nameeeee"), print(r.email), emit(AuthSuccess(r))},
    );
  }
